...
class Mobile: Bill
{
    ...
    init(BillId: Int , BillDate: String , BillType: Float , Totalamount: Float, mobile_manufacturer: String , plan_name: String , mobile_name: Int , net_used: Int , min_used: Int)
    {
